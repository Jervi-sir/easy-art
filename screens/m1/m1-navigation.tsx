        ...
        <ScrollView bounces={false} showsVerticalScrollIndicator={false} style={{ flex: 1, backgroundColor: COLORS.gray }}>
            ...
            <View style={{ marginTop: 25, paddingHorizontal: 20 }}>
                ...
                <FlatList
                    ...
                    renderItem={({ item }) => (
                        <TouchableOpacity style={{ padding: 15, borderRadius: 15, alignItems: 'center', marginRight: 15, marginTop: 10, shadowColor: '#000', shadowOffset: { width: 0, height: 1 }, shadowOpacity: 0.05, shadowRadius: 5, elevation: 2 }}>
