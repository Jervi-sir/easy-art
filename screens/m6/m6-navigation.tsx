    ...
    <SafeAreaView style={styles.container}>
      <ScrollView contentContainerStyle={{ paddingBottom: 20 }}>
        ...
        <View style={styles.menuContainer}>
          ...
          <TouchableOpacity style={styles.menuRow} onPress={() => navigation.navigate(Routes.SubscriptionScreen)}>
            <Ionicons name="card-outline" size={24} color={COLORS.primary} />
            <Text style={styles.menuText}>Abonnement</Text>
            <StatusBadge isPremium={user?.isPremium} />
            <Ionicons name="chevron-forward" size={22} color={COLORS.darkGray} style={{ marginLeft: 8 }} />
          </TouchableOpacity>
          ...
          <TouchableOpacity style={styles.menuRow} onPress={resetData}>
