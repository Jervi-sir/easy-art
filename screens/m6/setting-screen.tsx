    ...
    return (
        <View style={{ flex: 1, backgroundColor: COLORS.background }}>
            ...
            <ScrollView bounces={false}>
                ...
                <View style={styles.section}>
                    <SettingsRow icon="notifications-outline" title="Nouveaux événements" isSwitch switchValue={notifications.events} onSwitchChange={(value) => setNotifications({ events: value })} />
                    <SettingsRow icon="chatbubble-ellipses-outline" title="Messages" isSwitch switchValue={notifications.messages} onSwitchChange={(value) => setNotifications({ messages: value })} />
                    <SettingsRow icon="pricetag-outline" title="Promotions" isSwitch switchValue={notifications.promotions} onSwitchChange={(value) => setNotifications({ promotions: value })} />
                </View>
...
const SettingsRow = ({ icon, title, onPress, isSwitch, switchValue, onSwitchChange, hasChevron, value }) => {
    return (
